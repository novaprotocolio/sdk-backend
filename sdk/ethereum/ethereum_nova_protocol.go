...
func (*EthereumNovaProtocol) GenerateOrderData(version, expiredAtSeconds, salt int64, asMakerFeeRate, asTakerFeeRate, makerRebateRate decimal.Decimal, isSell, isMarket, isMakerOnly bool) string {
...
func (*EthereumNovaProtocol) GetMatchOrderCallData(takerOrder *sdk.Order, makerOrders []*sdk.Order, baseTokenFilledAmounts []*big.Int) []byte {
...
func getDomainSeparator() []byte {
	return crypto.Keccak256(
		...
		crypto.Keccak256([]byte("Nova Protocol")),
	)
}
