...
const (
	...
	DiscountedRate    = "0x4376abf1" // getDiscountedRate(address)
	...
	ERC20Withdraw     = "0x2e1a7d4d" // withdraw(uint256)
	ERC20Deposit      = "0xd0e30db0" // deposit()
	...
	ERC20WithdrawalEvent = "0x7fcf532c15f0a6db0bd6d0e038bea71d30d808c7d98cb3bf7268a95bf5081b65" // Withdrawal(address,uint256)
	ERC20DepositEvent    = "0xe1fffcc4923d04b559f4d29a8bfc6cda04eb5b0d3c460751c2402c5c5cc9109c" // Deposit(address,uint256)
)
...
func NewErc20Service(client *ethrpc.EthRPC) IErc20 {
	if client == nil {
		blockChainNodeUrl := os.Getenv("NSK_BLOCKCHAIN_RPC_URL")
		if len(blockChainNodeUrl) == 0 {
			panic(errors.New("empty env NSK_BLOCKCHAIN_RPC_URL"))
		}
