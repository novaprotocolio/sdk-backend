...
func (suite *novaTestSuite) SetupSuite() {
}

func (suite *novaTestSuite) TearDownSuite() {
}

func (suite *novaTestSuite) TearDownTest() {
}

func (suite *novaTestSuite) TestDomainHash() {
	suite.Equal(
...
func (suite *novaTestSuite) TestDomainSeparator() {
	suite.Equal(
...
func (suite *novaTestSuite) TestGetEIP712MessageHash() {
...
func (suite *novaTestSuite) TestIsValidSignature() {
...
func (suite *novaTestSuite) TestIsValidOrderSignature() {
	...
	suite.Equal(true, new(EthereumNovaProtocol).IsValidOrderSignature(taker, orderHash, signature))
}
...
func (suite novaTestSuite) TestGetOrderData() {
...
func (suite *novaTestSuite) TestGetHash() {
	taker := "0x3870b6f2c0b723f4855d8ad53ab7599b02d4df84"
...
func (suite *novaTestSuite) TestGetMatchOrdersDataHex() {
	taker := "0x3870b6f2c0b723f4855d8ad53ab7599b02d4df84"
...
func (suite *novaTestSuite) TestGetAsTakerFeeRateFromOrderData2() {
	data := "01010102540be3ff006400c8006400000000000df8f400000000000000000000"
...
func (suite *novaTestSuite) TestA() {
	config := "0x1234"
...
func (suite *novaTestSuite) TestExpireTs() {
